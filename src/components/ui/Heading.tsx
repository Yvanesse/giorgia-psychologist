...
const variants: Record<HeadingVariant, string> = {
  display: "font-sans text-5xl font-medium leading-[0.95] tracking-[-0.045em] text-ink sm:text-7xl lg:text-8xl",
  h1: "font-sans text-4xl font-medium leading-tight tracking-[-0.035em] text-ink sm:text-6xl",
  h2: "font-sans text-3xl font-medium leading-tight tracking-[-0.03em] text-ink sm:text-5xl",
