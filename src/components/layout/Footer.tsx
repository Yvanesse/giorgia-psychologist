        ...
        <div className="grid gap-8 md:grid-cols-[1fr_auto]">
          ...
          <nav aria-label="Footer" className="flex flex-wrap gap-x-6 gap-y-3">
            {footerContent.legalLinks.map((item) => (
              <a
                className="text-base text-ink-soft hover:text-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary"
                href={item.href}
                key={item.label}
              >
                {item.label}
            ...
            <a
              className="text-base text-ink-muted hover:text-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary"
              href="/area-riservata"
            >
              Area riservata
            </a>
